...
funded initiative. Each stands alone (courses run ~6 months apart).
...
and throughout ISYS6020.

## What Course 3 (AI in Delivery) now owns
...
Course 2 owns *should we / which / is it worth it* (business case, investment
scoring, build/buy). Course 3 starts **after** funding: *now ship it.* Course 3's
scoping is **delivery** scoping, not business-case scoping. See
`sites/ai-in-strategy/REVAMP-HANDOFF-NOTE.md` for keeping the seam clean when
Course 2 is revamped.

## Flow into the university units

| Exec-Ed source | ISYS unit / week | Purpose |
|---|---|---|
| Trust tool (Course 1–3) | ISYS6020 Wk 1 (and throughout) | When to trust AI |
| Delivery scoping, "good enough" (Course 3) | ISYS6014 Wk 5 | Define success criteria |
| Human-in-the-loop design (Course 3) | ISYS6014 / ISYS6020 | Where judgement stays |
| DDCD crisis response (Course 3) | ISYS6020 Wk 10 | Governance under pressure |
| Scale/Pivot/Kill (Course 3) | ISYS6014 Wk 10 | Evidence-based post-pilot calls |
