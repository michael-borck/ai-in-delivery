...
description: "Automated price optimisation — high value, high stakes, and the data isn't ready. ($850K, funded.)"
---
...
- A pricing model that looks great in backtesting (the "demo") can behave badly in live conditions it never saw — exactly the demo-to-production gap, with money attached.
