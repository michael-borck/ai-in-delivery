...
| Warehouse operations email | 🎣 | Mostly noise (forklift safety, farewell, car park). **Needle:** chronic nil-stock on homewares candles in regional stores, which points at the pilot category. |
